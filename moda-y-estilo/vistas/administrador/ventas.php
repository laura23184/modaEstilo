 ...
 <div class="mm">
                <div class="content-section" id="reportes-section" >
                    <div class="page-header">
                        <h1>VENTAS</h1>
                        <p>Análisis y estadísticas del inventario</p>
                    </div>
                    ...
                    <div class="filtros-reportes">
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <label for="reporte-fecha">Rango de fechas</label>
                                <select id="reporte-fecha">
                            ...
                            <div class="form-group">
                                <label for="reporte-categoria">Filtrar por categoría</label>
                    ...
                    <div class="reporte-container" style="margin-top: 30px;">
                        <div class="reporte-grafico">
                            <h3>Ventas por categoría (Últimos 30 días)</h3>
                            <div id="grafico-ventas" style="height: 300px; background: #f8f9fa; border-radius: 8px; display: flex; align-items: center; justify-content: center;">
